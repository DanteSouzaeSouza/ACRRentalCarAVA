using System;
using System.Data;
using System.Data.SqlClient; //inclui namespace para o banco SqlServer
...
namespace ACRRentalCarAVA
{
    ...
    {
        // Criando uma variável do tipo FrmCadastroCliente
        private readonly FrmCadastroCliente frmCliente;

        // adicionando parâmetro ao método construtor do formulário
        public FrmConsultaCliente(FrmCadastroCliente frmCliente)
        {
            // associando parâmetro recebido no método construtor com objeto interno frmCliente
        ...
        private void FrmConsultaCliente_Load(object sender, EventArgs e)
        {
            ...
            {
                MessageBox.Show("Problema ao listar clientes " + ex, "ACR Rental Car", MessageBoxButtons.OK,
